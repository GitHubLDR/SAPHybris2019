...
public class DefaultLdrpromotionsService implements LdrpromotionsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultLdrpromotionsService.class);
	...
	{
		return DefaultLdrpromotionsService.class.getResourceAsStream("/ldrpromotions/sap-hybris-platform.png");
	}
