 ...
 */
package com.ldr.promotions.jalo;
...
/**
 * This is the extension manager of the Ldrpromotions extension.
 */
public class LdrpromotionsManager extends GeneratedLdrpromotionsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(LdrpromotionsManager.class);
	 ...
	 */
	public static LdrpromotionsManager getInstance()
	{
		return (LdrpromotionsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(LdrpromotionsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public LdrpromotionsManager() // NOPMD 
	{
		LOG.debug("constructor of LdrpromotionsManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of LdrpromotionsManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of LdrpromotionsManager called, current tenant: {}", getTenant().getTenantID());
	}
